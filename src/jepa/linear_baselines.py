...
# Fit models
multiclass_opt = "multinomial" if len(np.unique(y_train)) > 2 else "auto"
models = {'LR': LogisticRegression(C=2, max_iter=10000,  multi_class=multiclass_opt, random_state=seed), \
